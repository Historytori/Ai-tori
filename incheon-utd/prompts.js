// prompts.js – 실습파일 링크 및 다중 프롬프트 분리 적용
const promptsData = {
  link: [
...
17. Suno(음악AI) https://suno.com/home/`
  ...
  draw1: [
    ...
    `갈매기를 두루미(학)로 바꾸어 생성해 줘.`
  ],

  draw2: [
    `게겐프레싱 전술 설명해줘.`,
    `웹툰 형식으로 그려줘. 핵심 개념, 장점, 단점, 활용 구단 포함.`
  ],

  draw3: [
    `2005년 K리그 준우승 다큐 <비상> 포스터 리디자인 요청.`
  ],

  draw4: [
    `손흥민과 2025 인천유나이티드 유니폼 합성 이미지 제작.`
  ],

  mindmap: [
    `인천유나이티드 vs 부산아이파크 원정 관람 1박2일 여행 마인드맵 만들어줘.`
  ],
