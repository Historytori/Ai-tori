...
7. 삼행시뿐만 아니라, 사행시부터 구행시까지 요구하는 단어 글자 수만큼 만들어줘.`],
  goods: [`인천유나이티드 굿즈 기획, 양말 디자인, 03 포함 요청`],
  emoji: [`이모티콘용 캐릭터 생성, 감정 16가지, MBTI 액션 시트 표현 요청`],
  figure: [`무고사 캐릭터와 액세서리를 포함한 액션 피규어 세트 목업 생성 요청`],
  summary: [`인천유나이티드 전망 기사 수집, 키워드 도출, 마인드맵 생성, multilingual 음원 변환 요청`],
  cheer: [`응원가 작곡 스타일 지정, Suno 프롬프트, 키워드 포함 가사 요청`],
